...
// Source: file_store/file_store.go
...
import (
	...
	file_store "github.com/chrismcgehee/lyncser/file_store"
...
func (m *MockFileStore) GetFiles() ([]*file_store.StoredFile, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFiles")
	ret0, _ := ret[0].([]*file_store.StoredFile)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
